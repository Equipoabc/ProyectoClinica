...
public class GUI_InterfazCamas extends javax.swing.JFrame {
    
    public GUI_InterfazCamas(){
    ...
    private void initComponents() {
        ...
        administradorLabel.setText("Camas");
        ...
        registrarCama.setBorderPainted(false);
        registrarCama.setContentAreaFilled(false);
        registrarCama.setFocusPainted(false);
    ...
    private void registrarCamaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registrarCamaActionPerformed
       GUI_RegistrarCama interfazLogin = new GUI_RegistrarCama();
        interfazLogin.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]){
        ...
        java.awt.EventQueue.invokeLater(new Runnable(){
            ...
            public void run(){
                ...
                new GUI_InterfazCamas().setVisible(true);
            }
        });
    }
